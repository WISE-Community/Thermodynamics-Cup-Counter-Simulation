...
var dataPointHandler_1 = require("./dataPointHandler");
var $ = require("jquery");
/**
...
var AnimationHandler = /** @class */ (function () {
     ...
     */
    function AnimationHandler(cupCounterModel) {
        /*
        ...
        this.dataPointHandler = new dataPointHandler_1.DataPointHandler();
        /*
         * Create local references to these objects so that they can be used in the
         * event handlers.
         */
        var thisAnimationHandler = this;
        var thisCupCounterModel = this.cupCounterModel;
        var thisDataPointHandler = this.dataPointHandler;
        ...
        $('#secondTimer').on('animationiteration', function () {
            ...
            var time = thisAnimationHandler.getTimeCounter();
            var cupTemperature = thisDataPointHandler.getCupTemperature(time);
            var counterTemperature = thisDataPointHandler.getCounterTemperature(time);
     ...
     */
    AnimationHandler.prototype.startCupLowering = function () {
        $('#cupDiv').addClass('cupMovementAnimation');
    };
    /**
     * Start the heat transfer animation on the cup and counter.
     */
    AnimationHandler.prototype.startHeatTransfer = function () {
     ...
     */
    AnimationHandler.prototype.getTimeCounter = function () {
        return this.time;
    };
    /**
     * Increment the model timer by 1 second.
     */
    AnimationHandler.prototype.incrementTimeCounter = function () {
        this.time += 1;
    };
    /**
     * Set the model timer back to 0 seconds.
     */
    AnimationHandler.prototype.resetTimeCounter = function () {
        this.time = 0;
    };
    /**
     ...
     */
    AnimationHandler.prototype.resetAnimations = function () {
     ...
     */
    AnimationHandler.prototype.setCupTemperatureReadout = function (temp) {
        $('#cupTemperatureReadout').html(Math.floor(temp) + '&#8451;');
    };
    /**
     * Set the counter temperature that's actually displayed on the counter.
     */
    AnimationHandler.prototype.setCounterTemperatureReadout = function (temp) {
...
},{"./dataPointHandler":5,"jquery":1}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var $ = require("jquery");
/**
...
var Button = /** @class */ (function () {
     ...
     */
    Button.prototype.showPlayButton = function () {
        this.setButtonIcon('play_arrow');
    };
    /**
     * Show the pause icon on the button.
     */
    Button.prototype.showPauseButton = function () {
        this.setButtonIcon('pause');
    };
    /**
     * Show the restart icon on the button.
     */
    Button.prototype.showRestartButton = function () {
     ...
     */
    Button.prototype.setButtonIcon = function (text) {
        $('#buttonIcon').html(text);
    };
    /**
     * The model has been paused.
     */
    Button.prototype.modelPaused = function () {
        this.showPlayButton();
    };
    /**
     * The model is now playing.
     */
    Button.prototype.modelPlayed = function () {
 ...
 */
var CupCounterModel = /** @class */ (function () {
    function CupCounterModel() {
        this.state = 'initialized';
        this.animationHandler = new animationHandler_1.AnimationHandler(this);
        this.button = new button_1.Button(this);
    }
    /**
     ...
     */
    CupCounterModel.prototype.play = function () {
     ...
     * Pause the model.
     */
    CupCounterModel.prototype.pause = function () {
     ...
     */
    CupCounterModel.prototype.resume = function () {
        this.setState('playing');
     ...
     */
    CupCounterModel.prototype.restart = function () {
        this.setState('playing');
     ...
     */
    CupCounterModel.prototype.getState = function () {
        return this.state;
    };
    /**
     ...
     */
    CupCounterModel.prototype.setState = function (state) {
        this.state = state;
    };
    /**
     ...
     */
    CupCounterModel.prototype.isStatePlaying = function () {
        return this.state == 'playing';
    };
    /**
     * Set the state of the model to completed.
     */
    CupCounterModel.prototype.setCompleted = function () {
        this.state = 'completed';
        this.button.showRestartButton();
    };
    return CupCounterModel;
}());
exports.CupCounterModel = CupCounterModel;

},{"./animationHandler":2,"./button":3}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
 ...
 */
var DataPointHandler = /** @class */ (function () {
    function DataPointHandler() {
        this.trial = new trial_1.Trial();
        this.wiseAPI = new wiseAPI_1.WISEAPI();
     ...
     * [time, temperature]
     */
    DataPointHandler.prototype.getCupTemperatureDataPoint = function (time) {
     ...
     * [time, temperature]
     */
    DataPointHandler.prototype.getCounterTemperatureDataPoint = function (time) {
     ...
     */
    DataPointHandler.prototype.getCupTemperature = function (time) {
     ...
     */
    DataPointHandler.prototype.getCounterTemperature = function (time) {
     ...
     */
    DataPointHandler.prototype.getDataPointX = function (dataPoint) {
        return dataPoint[0];
    };
    /**
     ...
     */
    DataPointHandler.prototype.getDataPointY = function (dataPoint) {
        return dataPoint[1];
    };
    /**
     ...
     */
    DataPointHandler.prototype.addDataPointsToTrial = function (time) {
        var cupTemperatureDataPoint = this.getCupTemperatureDataPoint(time);
        var counterTemperatureDataPoint = this.getCounterTemperatureDataPoint(time);
     ...
     */
    DataPointHandler.prototype.intializeAndSendTrial = function () {
     ...
     */
    DataPointHandler.prototype.updateAndSendTrial = function (time) {
...
exports.DataPointHandler = DataPointHandler;

},{"./trial":7,"./wiseAPI":8}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var cupCounterModel_1 = require("./cupCounterModel");
var $ = require("jquery");
$(document).ready(function () {
    var cupCounterModel = new cupCounterModel_1.CupCounterModel();
});

},{"./cupCounterModel":4,"jquery":1}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
var Trial = /** @class */ (function () {
     ...
     */
    Trial.prototype.initializeTrial = function () {
        this.trial = {};
     ...
     */
    Trial.prototype.toJsonObject = function () {
        return this.trial;
    };
    /**
     ...
     */
    Trial.prototype.createSeries = function (name, color, marker) {
        return {
            name: name,
            color: color,
     ...
     */
    Trial.prototype.addDataPointToSeries = function (series, x, y) {
     ...
     */
    Trial.prototype.addDataPointToCupSeries = function (x, y) {
     ...
     * @param y The y value of the data point. This will be the temperature.
     */
    Trial.prototype.addDataPointToCounterSeries = function (x, y) {
     ...
     */
    Trial.prototype.getCupSeries = function () {
     ...
     */
    Trial.prototype.getCounterSeries = function () {
...
var WISEAPI = /** @class */ (function () {
     ...
     */
    WISEAPI.prototype.save = function (trial) {
        var componentState = this.createComponentState(trial);
     ...
     */
    WISEAPI.prototype.createComponentState = function (trial) {
        var trials = [trial];
        var componentState = {};
